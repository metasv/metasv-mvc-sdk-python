...
class ContractApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __contract_nft_auction_code_hash_code_hash_nft_id_nft_id_utxo_get(
            self,
            code_hash,
            nft_id,
            **kwargs
            ...
            >>> thread = api.contract_nft_auction_code_hash_code_hash_nft_id_nft_id_utxo_get(code_hash, nft_id, async_req=True)
            >>> result = thread.get()
        ...
        self.contract_nft_auction_code_hash_code_hash_nft_id_nft_id_utxo_get = Endpoint(
            settings={
                'response_type': ([ContractNftAuctionUtxo],),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/contract/nft/auction/codeHash/{codeHash}/nftId/{nftId}/utxo',
                'operation_id': 'contract_nft_auction_code_hash_code_hash_nft_id_nft_id_utxo_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__contract_nft_auction_code_hash_code_hash_nft_id_nft_id_utxo_get
        )
        ...
        def __contract_nft_sell_v2_address_address_utxo_get(
            self,
            address,
            **kwargs
        ):
            ...
            >>> thread = api.contract_nft_sell_v2_address_address_utxo_get(address, async_req=True)
            >>> result = thread.get()
        ...
        self.contract_nft_sell_v2_address_address_utxo_get = Endpoint(
            settings={
                'response_type': ([ContractNftSellV2Utxo],),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/contract/nft/sellV2/address/{address}/utxo',
                'operation_id': 'contract_nft_sell_v2_address_address_utxo_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__contract_nft_sell_v2_address_address_utxo_get
        )

        def __contract_nft_sell_v2_genesis_code_hash_genesis_utxo_get(
            self,
            code_hash,
            genesis,
            **kwargs
            ...
            >>> thread = api.contract_nft_sell_v2_genesis_code_hash_genesis_utxo_get(code_hash, genesis, async_req=True)
            >>> result = thread.get()
        ...
        self.contract_nft_sell_v2_genesis_code_hash_genesis_utxo_get = Endpoint(
            settings={
                'response_type': ([ContractNftSellV2Utxo],),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/contract/nft/sellV2/genesis/{codeHash}/{genesis}/utxo',
                'operation_id': 'contract_nft_sell_v2_genesis_code_hash_genesis_utxo_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__contract_nft_sell_v2_genesis_code_hash_genesis_utxo_get
        )
